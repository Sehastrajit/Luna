"""
Proactive scheduler — runs background checks and Windows notifications.
"""
import re
import subprocess
import asyncio
...
def mine_behavioral_patterns():
    ...
    try:
        ...
        # Emotionally charged day-of-week patterns
...
def proactive_commitment_followup():
    ...
    try:
        ...
        # Throttle: max one follow-up per 24 h
        recent = (
            db.query(ProactiveLog)
        ...
        end   = now - timedelta(hours=20)  # must be at least 20 h old
